...
<div align="center">
    <form action="">
        <select name="state" onchange="showOrders(this.value)">
            <option value="2" selected>全部订单</option>
...
<div id="txtHint">
    <table class="hovertable" border="solid" align="center" rules="rows">
        ...
        <%
            ...
            String sql = "select id,ordertime,price,state from orders where username = '" + username + "'order by ordertime desc";//查询订单（未完成、已完成）
...
<script type="text/javascript">
    ...
    function showOrders(state) {
        ...
        var url = "orders2.jsp";
        url = url + "?state=" + state + "&username='<%=username%>'";
...
<hr>
<div align="center"><a href="show_cars.jsp" style="display: block">
    <button class="button" style="width: 200px">返回</button>
</a></div>
</body>
</html>
